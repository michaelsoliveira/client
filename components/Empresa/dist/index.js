...
var Empresa = function (_a) {
    ...
    var _j = react_hook_form_1.useForm(formOptions), register = _j.register, handleSubmit = _j.handleSubmit, reset = _j.reset, errors = _j.formState.errors, getValues = _j.getValues, setValue = _j.setValue;
